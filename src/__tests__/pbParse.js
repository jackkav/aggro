...
test('should pull name from input', () => {
  expect(pbParse(example).full).toBe(
    'Sonu Ke Titu Ki Sweety (2018) Hindi 720p PRE x264 AAC Uploaded 11-20 04:08, Size 284 93 MiB, ULed by  makintos13',
  )
})
